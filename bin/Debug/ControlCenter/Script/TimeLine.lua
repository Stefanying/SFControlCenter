...
while true do
	...
	if lastTime ~= currentTime then
		PrintToLog(currentTime)
	curerntCommands = commands[currentTime];

	if curerntCommands ~= nil then
		for operationName,  operation in ipairs(curerntCommands) do
