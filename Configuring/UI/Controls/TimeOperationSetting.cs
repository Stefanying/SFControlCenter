...
{
    public partial class TimeOperationSetting : BaseForm
    {
        object _setting;
        ...
        public int DelayTime
        {
            ...
            {
                _time = value;
                tbMinute.Text = (value / 60).ToString();
                tbSecond.Text = (value % 60).ToString();
            }
        }

        public TimeOperationSetting()
        {
            InitializeComponent();
        }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _time = (int.Parse(tbMinute.Text) * 60 + int.Parse(tbSecond.Text)) * 1000;
        ...
        {
            bool ret = time < 3600 * 1000;
            if (!ret) Helper.ShowMessageBox("时间超时", "请确保时间小于60分");
            return ret;
        }
