...
local commands = {[1]  = { operationType ="Com", operationDataType ="Hex", operationData ="4131310d",Setting = {comNumber ="com3",baudRate = "9600",dataBit = "8",stopBit = "1",parity = "None"},operationTime ="100"},
[2]  = { operationType ="Com", operationDataType ="Hex", operationData ="4131310d",Setting = {comNumber ="com3",baudRate = "9600",dataBit = "8",stopBit = "1",parity = "None"},operationTime ="200"}
};
