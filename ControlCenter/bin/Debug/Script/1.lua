...
local commands = {[1]  = { operationType ="UDP", operationDataType ="Character", operationData ="video_open test.mp4",Setting = {ip = "127.0.0.1",port ="8878"},operationTime ="0"},
[2]  = { operationType ="UDP", operationDataType ="Character", operationData ="video_close",Setting = {ip = "127.0.0.1",port ="8878"},operationTime ="60000"}
};
