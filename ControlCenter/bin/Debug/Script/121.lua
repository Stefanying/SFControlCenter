...
local commands = {[1]  = { operationType ="Com", operationDataType ="Hex", operationData ="4131310d",Setting = {comNumber ="com2",baudRate = "19200",dataBit = "8",stopBit = "1",parity = "None"},operationTime ="100"}
};
